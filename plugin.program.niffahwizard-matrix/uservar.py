...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]NiffaH[/B][/COLOR]Wizard'
BUILDERNAME = 'NiffaH Wizard'
EXCLUDES = [ADDON_ID, 'repository.niffah']
# Text File with build info in it.
BUILDFILE = 'https://jayskee.github.io/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]NiffaH[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Niffah Wizard.\n\nContact us on Github at jayskee.github.io'
